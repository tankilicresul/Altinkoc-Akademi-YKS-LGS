...
import { GraduationCap, Award, Star, MessageSquare, CheckCircle, Sparkles, UserCheck } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-black hashtag-badge">
            ...
            <span>Türkiye Dereceli Mentör Kadrosu</span>
          </div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
            Sadece Derece Yapmış <span className="text-gradient-brand">Koçlarla Çalışın</span>
          </h2>
          <p className="text-slate-600 text-base md:text-lg font-medium">
            Boğaziçi, ODTÜ, İTÜ ve Hacettepe Tıp öğrencisi koçlarımız kendi sınav tecrübelerini ve 1.lik stratejilerini haftalık planlarla size aktarır.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {mentorsList.map((mentor) => (
            <div
              key={mentor.id}
              className="glass-panel-interactive border-2 border-amber-300 rounded-3xl p-6 md:p-8 bg-white shadow-xl space-y-5 flex flex-col justify-between"
            >
              <div className="space-y-4">
                ...
                {/* Specialty Box */}
                <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-200 text-xs font-extrabold text-slate-800 space-y-1">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-brand-gradient bg-brand-gradient-hover text-slate-950 font-black py-3 rounded-2xl text-xs transition shadow-md shadow-orange-500/20"
                >
